...
import {Icon, Table, Tabs, List, Avatar} from 'antd';
    ...
    return (
      <Tabs defaultActiveKey="1">
                ...
                renderItem={item => (
                  <List.Item className="comment-item">
                    <List.Item.Meta
                      ...
                      description={<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad beatae
        ...
        <Tabs.TabPane tab="Users" key="2">
          <Table bordered={true} pagination={false} size={'small'} columns={columns}
                 dataSource={data}/>
        </Tabs.TabPane>
